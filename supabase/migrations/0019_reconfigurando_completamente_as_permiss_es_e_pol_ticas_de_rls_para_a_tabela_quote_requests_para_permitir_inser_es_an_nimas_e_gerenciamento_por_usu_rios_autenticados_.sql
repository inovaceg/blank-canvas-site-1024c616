...
CREATE POLICY "anon_can_insert_quote_requests" ON public.quote_requests
FOR INSERT TO anon WITH CHECK (true);

CREATE POLICY "authenticated_can_select_quote_requests" ON public.quote_requests
FOR SELECT TO authenticated USING (true);

CREATE POLICY "authenticated_can_update_quote_requests" ON public.quote_requests
FOR UPDATE TO authenticated USING (true);

CREATE POLICY "authenticated_can_delete_quote_requests" ON public.quote_requests
