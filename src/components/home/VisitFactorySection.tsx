      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={mapRef} className="max-w-4xl mx-auto">
          <div className={`aspect-video rounded-lg overflow-hidden shadow-lg mb-8 transition-all duration-700 ${
            ...
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d465.19809298085987!2d-41.732340!3d-21.637652!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjHCsDM4JzE1LjYiUyA0McKwNDMnNTYuNCJX!5e1!3m2!1spt-BR!2sbr!4v1234567890&z=20"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
